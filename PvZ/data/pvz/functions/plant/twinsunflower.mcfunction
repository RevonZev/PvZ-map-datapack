# Summon
execute as @e[name="twin_sunflower"] at @s run summon minecraft:armor_stand ~ ~ ~ {ArmorItems:[{},{},{},{id:"minecraft:apple",Count:1b,tag:{CustomModelData:21}}],Rotation:[90.0f,0.0f],Invisible:1b,Tags:[plant,summoned,twinsunflower]}
execute as @e[name="twin_sunflower"] at @s run tp @s ~ ~-1000 ~
