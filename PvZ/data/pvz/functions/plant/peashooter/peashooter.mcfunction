# summon
execute as @e[name="peashooter"] at @s run summon minecraft:armor_stand ~ ~ ~ {ArmorItems:[{},{},{},{id:"minecraft:apple",Count:1b,tag:{CustomModelData:9}}],Rotation:[0.0f,0.0f],Invisible:1b,Tags:[plant,summoned,peashooter]}
...
execute as @e[tag=peashooter,tag=summoned] run function pvz:plant/peashooter/assign_plant_num
