...
execute as @e[tag=pea_snow_bullet] at @s as @e[type=zombie,sort=nearest,limit=1,distance=..1] run scoreboard players remove @s z_health 20
execute as @e[tag=pea_snow_bullet] at @s as @e[type=zombie,sort=nearest,limit=1,distance=..1,tag=!door] run scoreboard players set @s z_SPslowtimer 1
execute as @e[tag=pea_snow_bullet] at @s as @e[type=zombie,sort=nearest,limit=1,distance=..1,tag=!door] run tag @s add slowed
execute as @e[tag=pea_snow_bullet] at @s as @e[type=zombie,sort=nearest,limit=1,distance=..1] run effect give @s instant_health 1 1
