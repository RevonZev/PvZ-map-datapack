execute as @e[tag=pvz_slot_0] run data modify entity @s CustomName set from entity @p Inventory[0].tag.plant_font
execute as @e[tag=pvz_slot_1] run data modify entity @s CustomName set from entity @p Inventory[1].tag.plant_font
execute as @e[tag=pvz_slot_2] run data modify entity @s CustomName set from entity @p Inventory[2].tag.plant_font
execute as @e[tag=pvz_slot_3] run data modify entity @s CustomName set from entity @p Inventory[3].tag.plant_font
