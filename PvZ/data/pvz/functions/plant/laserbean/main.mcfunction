# summon
execute as @e[name="Laser Bean"] at @s run summon minecraft:armor_stand ~ ~ ~ {ArmorItems:[{},{},{},{id:"minecraft:apple",Count:1b,tag:{CustomModelData:40}}],Rotation:[-90.0f,0.0f],Invisible:1b,Tags:[plant,summoned,laserbean]}
execute as @e[name="Laser Bean"] at @s run tp @s ~ ~-1000 ~
