...
execute if score Player sun >= sun_cost sun unless block ~ ~ ~ minecraft:air positioned ^ ^ ^-1 align xyz positioned ~0.5 ~ ~0.5 run function pvz:player/event/right_click/summon_object
