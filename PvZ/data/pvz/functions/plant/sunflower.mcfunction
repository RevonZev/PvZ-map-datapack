# Summon
execute as @e[name="Sunflower",type=!item] at @s run summon minecraft:armor_stand ~ ~ ~ {ArmorItems:[{},{},{},{id:"minecraft:apple",Count:1b,tag:{CustomModelData:8}}],Rotation:[90.0f,0.0f],Invisible:1b,Tags:[plant,summoned,sunflower]}
...
execute as @e[tag=sunflower,scores={ability_cooldown=480}] at @s run summon minecraft:item ~ ~1 ~ {Item:{id:"minecraft:sunflower",tag:{display:{Name:'{"text":"Sun x50"}'}},Count:1b,Damage:0s},Motion:[0d,0.5d,0d],Tags:[sun]}
